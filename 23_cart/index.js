    ...
    data.map((ele) => {
        ...
        <div class="col-3">
                <div class="card h-100">
                    <img src=${ele.image} height="250px" class="card-img-top border" alt="...">
                    <div class="card-body">
                    <div class="d-flex justify-content-between">
                    <span class="badge text-bg-success"> ${ele.rating.count}</span>
                    <span class="badge text-bg-light">⭐ ${ele.rating.rate}</span>
                    </div>
